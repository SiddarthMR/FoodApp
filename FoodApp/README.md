...
FoodApp is a **Java-based web application** that allows users to browse restaurants, view menus, add items to a cart, and place orders online. The application is built using **JSP, Servlets, JDBC, and MySQL**, following a simple MVC-style architecture.

This repository contains only **source code and resources**. Server software (Tomcat) and sensitive configurations are intentionally excluded.
